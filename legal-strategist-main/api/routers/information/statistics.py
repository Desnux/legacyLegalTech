...
from models.api import CaseStatsEventInformation, CaseStatsInformation, CaseStatsResponse, error_response
from models.sql import CaseParty, CaseStatsEvent
...
async def get_cases_csv(bank: str, session: Session = Depends(get_session)):
