    ...
    async def extract_information(self, request: DigitalCuratorsRequest) -> DigitalCuratorsResponse:
        ...
        try:
            async with async_playwright() as p:
                ...
                await page.wait_for_selector('#select_14', state="visible")
                await page.locator('#select_14').click()
                await page.wait_for_selector('#select_option_13', state="visible")
                await page.locator('#select_option_13').click()
                ...
                num_items -= 1
                await browser.close()
                return DigitalCuratorsResponse(message="Success", status=200, data=response_items, total_items=num_items)
