...
from models.sql import Case, CaseEvent, CaseStatus, Litigant
...
class CaseRetriever:
    ...
    def get_cases(self, 
        ...
        """Filters, orders, and returns a paginated list of cases with litigants."""
        query = select(Case).options(selectinload(Case.litigants))
