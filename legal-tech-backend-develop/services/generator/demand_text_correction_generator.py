...
class DemandTextCorrectionGenerator(BaseGenerator):
    ...
    def generate(self, dispatch_resolution: DispatchResolutionInformation, demand_text: DemandTextStructure) -> DemandTextCorrection:
        ...
        corrections = self._generate_corrections(dispatch_resolution.resolution, demand_text_content)
