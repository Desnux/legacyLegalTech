...
class DocumentType(str, Enum):
    ...
    OTHER = "other"
    SENTENCE = "sentence"
    ASSET_SEIZURE_ORDER = "asset_seizure_order"
...
class LegalExceptionRequest(str, Enum):
    ...
    def get_prompt(self, context: str, data: dict, locale: Locale) -> str:
        ...
        prompt += "\nIf you lack context for certain information, remove it and adapt the text, NEVER leave a placeholder in. Also, DO NOT create placeholders for the user to fill."
        return prompt
...
class LegalSubject(str, Enum):
    ...
    PROMISSORY_NOTE_COLLECTION = "promissory_note_collection"
