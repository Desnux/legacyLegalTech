...
from .homespotter_property import PropertyDataResponse, OwnerData, Contactability, ContactDetail as HSContactDetail, SIIData, Construction, TaxesData, MarketData, GoogleData, NearbyPlacesData, PRCData
from .homespotter_owner import OwnerDataResponse as OwnerDetailResponse, OwnedSociety

from .homespotter_additional import OwnedPropertyDetailed
from .homespotter_tenant import TenantReportResponse, ActiveVehicle
from .case_notebook import CaseNotebookRequest, CaseNotebookResponse, CaseNotebookItem, PaginatedCaseNotebookResponse
