...
class PJUDABDTE(BaseModel):
    raw_name: str = Field(..., description="Raw name of the AB.DTE. entity")
    identifier: str = Field(..., description="RUT of the AB.DTE. entity")
...
class PJUDDTE(BaseModel):
    raw_address: str = Field(..., description="Raw main address of the DTE. entity")
    raw_name: str = Field(..., description="Raw name of the DTE. entity")
    identifier: str = Field(..., description="RUT of the DTE. entity")
    legal_representatives: list[PJUDLegalRepresentative] = Field(default_factory=list, description="Legal representatives of the DTE. entity, if any")
