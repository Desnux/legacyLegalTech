...
const DateInput = ({ name, label, register, setValue, placeholder, formatValue, validateValue, required = false, errors, help, className }: DateInputProps) => {
