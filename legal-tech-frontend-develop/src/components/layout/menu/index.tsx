...
const Menu = ({ closeMenu }: { closeMenu?: () => void }) => {
      ...
      <div key={item.route}>
        ...
        <div
          className={classNames(
            ...
            { "bg-blue-600 text-white hover:bg-blue-600/80": isCurrent },
            { "bg-white text-gray-900 hover:bg-blue-200": isParent },
            { "bg-white text-gray-900 hover:bg-blue-200": !isCurrent && !isParent },
          )}
        >
          <Link
            href={item.route}
  ...
  return (
    <nav className="w-56 h-full bg-gray-400 pt-4 px-4 flex flex-col gap-y-2 overflow-y-auto">
