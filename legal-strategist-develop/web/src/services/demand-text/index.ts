...
async function sendDemandText({ 
  ...
  return sendRequest<DemandTextSenderResponse>("/send/demand-text/", "POST", formData);
}

export { analyzeDemandTextFromStructure, extractDemandTextInput, generateDemandTextFromStructure, sendDemandText };
