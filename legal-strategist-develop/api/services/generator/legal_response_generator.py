...
from services.v2.document.dispatch_resolution import DispatchResolutionInformation
...
class LegalResponseGenerator(BaseGenerator):
    ...
    def generate_from_dispatch_resolution(self, dispatch_resolution: DispatchResolutionInformation, demand_text: DemandTextStructure | None = None) -> LegalResponse:
        ...
        response = self._generate_dispatch_resolution_response(dispatch_resolution.resolution, demand_text_content, "resolution")
